...
HD_PWD='C:/Users/staro/Desktop/Lab_12/Lab_12.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FibonacciCounter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FibonacciCounter.tcl -notrace
