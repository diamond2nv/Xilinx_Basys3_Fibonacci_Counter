...
HD_PWD='C:/Users/staro/Desktop/Lab_12/Lab_12.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FibonacciCounter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FibonacciCounter.tcl
